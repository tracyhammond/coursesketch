...
public class TimeManager {
	...
	public static Request clientReciveTimeDiff(Request req) {
		...
		System.out.println("answer Recived Time");
		timeDifferance = req.getMessageTime() - getSystemTime();
		System.out.println("proxy time:"+MilltoDate(req.getMessageTime()));
		System.out.println("answer time:"+MilltoDate(DateTime.now().getMillis()));
