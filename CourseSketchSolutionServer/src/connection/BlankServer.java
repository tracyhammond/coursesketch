 ...
 */
public class BlankServer extends WebSocketServer {
	...
	public BlankServer( int port ) throws UnknownHostException {
		this( new InetSocketAddress( port ) );
	}

	public BlankServer( InetSocketAddress address ) {
		super( address );
	}
	...
	public static void main( String[] args ) throws InterruptedException , IOException {
		...
		BlankServer s = new BlankServer( port );
		s.start();
