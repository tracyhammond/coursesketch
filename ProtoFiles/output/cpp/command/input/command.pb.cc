...
void protobuf_AssignDesc_input_2fcommand_2eproto() {
  protobuf_AddDesc_input_2fcommand_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_input_2fcommand_2eproto);
}
...
void protobuf_ShutdownFile_input_2fcommand_2eproto() {
...
void protobuf_AddDesc_input_2fcommand_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "apeId\030\002 \002(\t", 251);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "input/command.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_input_2fcommand_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_input_2fcommand_2eproto {
  StaticDescriptorInitializer_input_2fcommand_2eproto() {
    protobuf_AddDesc_input_2fcommand_2eproto();
  }
} static_descriptor_initializer_input_2fcommand_2eproto_;
...
const PackageShape& PackageShape::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_input_2fcommand_2eproto();
