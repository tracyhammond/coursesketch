...
_SRL_SHAPE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='objects', full_name='protobuf.srl.sketch.SRL_Shape.objects', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='strokes', full_name='protobuf.srl.sketch.SRL_Shape.strokes', index=6,
...
_SRL_SKETCH.fields_by_name['sketch'].message_type = _SRL_SHAPE
_SRL_SHAPE.fields_by_name['interpretations'].message_type = _INTERPRETATION
_SRL_SHAPE.fields_by_name['objects'].message_type = _SRL_SHAPE
_SRL_SHAPE.fields_by_name['strokes'].message_type = _SRL_STROKE
