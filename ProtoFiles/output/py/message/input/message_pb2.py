...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb='\n\x13input/message.proto\x12\x14protobuf.srl.request\"\xfe\x01\n\x07Request\x12\x35\n\x05login\x18\x01 \x02(\x0b\x32&.protobuf.srl.request.LoginInformation\x12\x45\n\x0brequestType\x18\x02 \x02(\x0e\x32).protobuf.srl.request.Request.MessageType:\x05LOGIN\x12\x11\n\totherData\x18\x03 \x01(\x0c\"b\n\x0bMessageType\x12\t\n\x05LOGIN\x10\x00\x12\x10\n\x0c\x44\x41TA_REQUEST\x10\x01\x12\x10\n\x0c\x44\x41TA_SENDING\x10\x02\x12\x0f\n\x0bRECOGNITION\x10\x03\x12\x13\n\x0f\x41NSWER_CHECKING\x10\x04\"K\n\x10LoginInformation\x12\x10\n\x08username\x18\x01 \x02(\t\x12\x10\n\x08password\x18\x02 \x01(\t\x12\x13\n\x0bsessionInfo\x18\x03 \x01(\t')
...
_REQUEST_MESSAGETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ANSWER_CHECKING', index=4, number=4,
      options=None,
      type=None),
  ],
...
_REQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='login', full_name='protobuf.srl.request.Request.login', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='requestType', full_name='protobuf.srl.request.Request.requestType', index=1,
...
_LOGININFORMATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sessionInfo', full_name='protobuf.srl.request.LoginInformation.sessionInfo', index=2,
