...
_REQUEST_MESSAGETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FEEDBACK', index=8, number=8,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_REQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='messageTime', full_name='protobuf.srl.request.Request.messageTime', index=6,
