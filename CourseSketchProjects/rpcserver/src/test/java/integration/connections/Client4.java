...
public final class Client4 extends ClientWebSocket {

    /**
     * Declaration and Definition of Logger.
     */
    private static final Logger LOG = LoggerFactory.getLogger(Client4.class);
     ...
     */
    public Client4(final URI destination, final AbstractServerWebSocketHandler parent) {
