 ...
 */
public class FakeLoginConnectionState extends MultiConnectionState {
     ...
     */
    public FakeLoginConnectionState(final String inputKey) {
        super(inputKey);
    }
     ...
     */
    /* package-private */
    public final void logIn(final boolean instructorFlag, final String iSessionId) {
        loggedIn = true;
