...
public class ManyTestAssignments {
	public static void testAssignments(String courseId, String mastId) {
		String[] name = new String[]{"Assignment10"};		/*Assignment9*//*Assignment8*//*Assignment7*//*Assignment6*//*"Assignment5"*//*"Assignment4"*//*"Assignment3"*/
		String[] descsription = new String[]{"Due Friday 04/18/2014 at midnight. This is the tenth assignment."};
		for (int k = 0; k < 1; k ++) {
			...
			testBuilder.setCloseDate(RequestConverter.getProtoFromMilliseconds((new Date(1397883599000L/*1397278799000L*//*1396673999000L*//*1395291599000L*//*1394085599000L*//*1393480799000L*//*1392875999000L*//*1392703199000L*/).getTime())));
			Date d = new Date();
			d.setYear(2014-1900);
			d.setMonth(1);
			d.setDate(21);
