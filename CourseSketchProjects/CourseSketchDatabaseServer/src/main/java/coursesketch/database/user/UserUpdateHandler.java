package coursesketch.database.user;
...
import coursesketch.database.institution.mongo.UpdateManager;
...
import static coursesketch.database.util.DatabaseStringConstants.GROUP_PREFIX;
import static coursesketch.database.util.DatabaseStringConstants.GROUP_PREFIX_LENGTH;
...
import static coursesketch.database.util.DatabaseStringConstants.USER_GROUP_COLLECTION;
