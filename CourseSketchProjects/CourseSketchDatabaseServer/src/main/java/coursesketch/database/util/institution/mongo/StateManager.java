...
import static coursesketch.database.util.DatabaseStringConstants.STATE_COLLECTION;
import static coursesketch.database.util.DatabaseStringConstants.STATE_COMPLETED;
import static coursesketch.database.util.DatabaseStringConstants.STATE_STARTED;
