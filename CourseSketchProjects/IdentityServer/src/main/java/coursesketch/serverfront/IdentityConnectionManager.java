 ...
 */
public class IdentityConnectionManager extends MultiConnectionManager {
     ...
     */
    public IdentityConnectionManager(final AbstractServerWebSocketHandler server, final ServerInfo serverInfo) {
