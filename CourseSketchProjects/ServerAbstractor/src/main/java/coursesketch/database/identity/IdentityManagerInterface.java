...
public interface IdentityManagerInterface {
     ...
     * @param authChecker
     *         Used to check permissions in the coursesketch.util.util.
     ...
     *
     * @param userName
     *         The username that is being added to the coursesketch.util.util.
     ...
     * @throws DatabaseAccessException
     *         thrown if there is a problem with the coursesketch.util.util.
     */
     ...
     * @throws AuthenticationException
     *         Thrown if there is data that can not be found in the coursesketch.util.util.
     */
