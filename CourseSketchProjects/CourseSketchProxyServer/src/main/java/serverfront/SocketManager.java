...
public class SocketManager {
    ...
    public static final long THREAD_SLEEP_TIME = 180000;
            ...
            public void run() {
                while (true) {
                    ...
                    while (userTimeManager.peek().getTimeSinceLastActive() >= EXPERATION_TIME) {
                        final ProxyConnectionState removedUser = userTimeManager.poll();
    ...
    public void updateManager(final ProxyConnectionState userID) {
    ...
    public void deleteManager(final ProxyConnectionState userID) {
        userTimeManager.remove(userID);
    }

    public void addToManager(final ProxyConnectionState userID) {
        userTimeManager.add(userID);
    }

    public void setExpiredListiner(final ActionListener experation) {
