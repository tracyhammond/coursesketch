...
public abstract class IGeneralConnectionRunner {
    ...
    protected final void runMost() {
        ...
        if (secure) {
            configureSSL(keystorePath, keystorePassword);
        }
     ...
     * @param iKeystorePassword the password for the keystore.
     * @param iKeystorePath the location of the keystore.
     */
    protected abstract void configureSSL(String iKeystorePath, String iKeystorePassword);
