...
function InputListener() {
    ...
    this.initializeCanvas = function initializeCanvas(canvasId) {
        if (!canvasId instanceof Element) {
    ...
    this.registerListeners = function registerListeners(element) {
        element.addEventListener('mousemove', function(event) {
            this.listenerScope.mouseMoved(event);
        }, false);
        element.addEventListener('mousedown', function(event) {
            this.listenerScope.mouseDown(event);
        }, false);
        element.addEventListener('mouseup', function(event) {
            this.listenerScope.mouseUp(event);
        }, false);
        element.addEventListener("mouseout", function(event) {
            this.listenerScope.mouseExit(event);
        }, false);
        ...
        element.addEventListener('touchmove', function(event) {
            this.listenerScope.mouseDragged(event);
        }, false);
    ...
    this.getTouchRadius = function getTouchRadius(touchEvent) {
        ...
        if (rY == 0 || rX == 0) return 0.5;
        radius = rY + rX / 2;
        if (isNaN(radius)) return .5;
        return radius;
    };
    ...
    /**
     * Sets the default listener, this is only called if a unique listener is
     * not set.
     */
    ...
    /**
     * Sets the listener for input moved. call this method with false to remove
     * the listener.
     */
    ...
    /**
     * Sets the listener for input dragged. call this method with false to
     * remove the listener.
     */
    ...
    /**
     * Sets the listener for the start of dragging. call this method with false
    ...
    /**
     * Sets the listener for the end of dragging. call this method with false to
     * remove the listener.
     */
    ...
    /**
     * Sets the listener for input enter. call this method with false to remove
     * the listener.
     */
    ...
    /**
     * Sets the listener for input exit. call this method with false to remove
     * the listener.
     */
    ...
    /**
     * Sets the listener for input down. call this method with false to remove
     * the listener.
     */
    ...
    /**
     * Sets the listener for input up. call this method with false to remove the
     * listener.
     */
...
/**
 * Creates an object wich passed to caller events with the given values. x: the
 * x coordinate at which the point is created. y: the y coordinate at which the
 * point is created. time: the time at which the point is created. pressure: the
 * pressure of the point, devices without pressure default to 0.5 This value is
 * always between 0 and 1 size: the size of the input for the point, devices
 * without size default to 0.5 This value is always between 0 and 1 type: the
 * type is either inputExit, inputUp, inputDown, inputMoved, inputEnter,
 * inputDragged
 */
