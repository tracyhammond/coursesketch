...
public class Solutions 
{
	public static String mongoInsertCourse(DB dbs, SrlCourse course)
	{
		...
		BasicDBObject query = new BasicDBObject(USERS,course.getUsers())
										 .append(ALLOWED_IN_PROBLEMBANK,course.get())
										 .append(PRACTICE_PROBLEM,course.getPraciceProblem()) 
										 .append(ADMIN,course.getSemester())
										 .append(SOLUTION, course.getAccessDate().getMillisecond());
