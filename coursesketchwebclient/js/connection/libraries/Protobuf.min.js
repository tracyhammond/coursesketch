...
"text/plain");if(l)a.onreadystatechange=function(){4==a.readyState&&(200==a.status?l(a.responseText):l(null))},4!=a.readyState&&a.send(null);else return a.send(null),a.responseText}};c.isArray=function(b){return!b?!1:b instanceof Array?!0:Array.isArray?Array.isArray(b):"[object Array]"===Object.prototype.toString.call(b)};return c}();h.Lang={OPEN:"{",CLOSE:"}",OPTOPEN:"[",OPTCLOSE:"]",OPTEND:",",EQUAL:"=",END:";",STRINGOPEN:'"',STRINGCLOSE:'"',COPTOPEN:"(",COPTCLOSE:")",DELIM:/[\s\{\}=;\[\],"\(\)]/g,
...
function(a){return"undefined"==typeof a?this.options:"undefined"!=typeof this.options[a]?this.options[a]:null};b.Namespace=f;var a=function(a,c,b){f.call(this,a,c,b);this.clazz=null};a.prototype=Object.create(f.prototype);a.prototype.build=function(){for(var d=function(a,b){var d=b.getChildren(a.Message.Field),g;try{g=eval("0, (function "+b.name+"() { ProtoBuf.Builder.Message.call(this); this.__construct.apply(this, arguments); })")}catch(e){g=function(){c.Builder.Message.call(this);this.__construct.apply(this,
arguments)}}g.prototype=Object.create(c.Builder.Message.prototype);g.prototype.__construct=function(a){var b,g;for(b=0;b<d.length;b++)g=d[b],this[g.name]=g.repeated?[]:null;for(b=0;b<d.length;b++)if(g=d[b],"undefined"!=typeof g.options["default"])try{this.set(g.name,g.options["default"])}catch(m){throw Error("[INTERNAL] "+m);}if(1==arguments.length&&"object"==typeof a&&"function"!=typeof a.encode&&!c.Util.isArray(a)&&!(a instanceof p)&&!(a instanceof ArrayBuffer)&&!(c.Long&&a instanceof c.Long)){g=
Object.keys(a);for(b=0;b<g.length;b++)this.set(g[b],a[g[b]])}else for(b=0;b<arguments.length;b++)b<d.length&&this.set(d[b].name,arguments[b])};g.prototype.add=function(c,d){var g=b.getChild(c);if(!g)throw Error(this+"#"+c+" is undefined");if(!(g instanceof a.Message.Field))throw Error(this+"#"+c+" is not a field: "+g.toString(!0));if(!g.repeated)throw Error(this+"#"+c+" is not a repeated field");null===this[g.name]&&(this[g.name]=[]);this[g.name].push(g.verifyValue(d,!0))};g.prototype.set=function(c,
d){var g=b.getChild(c);if(!g)throw Error(this+"#"+c+" is not a field: undefined");if(!(g instanceof a.Message.Field))throw Error(this+"#"+c+" is not a field: "+g.toString(!0));this[g.name]=g.verifyValue(d)};g.prototype.get=function(c){var d=b.getChild(c);if(!d||!(d instanceof a.Message.Field))throw Error(this+"#"+c+" is not a field: undefined");if(!(d instanceof a.Message.Field))throw Error(this+"#"+c+" is not a field: "+d.toString(!0));return this[d.name]};for(var m=0;m<d.length;m++)(function(a){var c=
a.name.replace(/(_[a-zA-Z])/g,function(a){return a.toUpperCase().replace("_","")}),c=c.substring(0,1).toUpperCase()+c.substring(1),d=a.name.replace(/([A-Z])/g,function(a){return"_"+a});b.hasChild("set"+c)||(g.prototype["set"+c]=function(c){this.set(a.name,c)});b.hasChild("set_"+d)||(g.prototype["set_"+d]=function(c){this.set(a.name,c)});b.hasChild("get"+c)||(g.prototype["get"+c]=function(){return this.get(a.name)});b.hasChild("get_"+d)||(g.prototype["get_"+d]=function(){return this.get(a.name)})})(d[m]);
g.prototype.encode=function(a){a=a||new p;var c=a.littleEndian;try{var d=b.encode(this,a.LE()).flip();a.littleEndian=c;return d}catch(g){throw a.littleEndian=c,g;}};g.prototype.toArrayBuffer=function(){return this.encode().toArrayBuffer()};g.prototype.toBuffer=function(){return this.encode().toBuffer()};g.prototype.toBase64=function(){return this.encode().toBase64()};g.decode=function(a){a=a?a instanceof p?a:p.wrap(a):new p;var c=a.littleEndian;try{var d=b.decode(a.LE());a.littleEndian=c;return d}catch(g){throw a.littleEndian=
c,g;}};g.decode64=function(a){return g.decode(p.decode64(a))};g.prototype.toString=function(){return b.toString()};Object.defineProperty&&Object.defineProperty(g,"$options",{value:b.buildOpt(),enumerable:!1,configurable:!1,writable:!1});return g}(b,this),m=this.getChildren(),q=0;q<m.length;q++)if(m[q]instanceof e)d[m[q].name]=m[q].build();else if(m[q]instanceof a)d[m[q].name]=m[q].build();else if(!(m[q]instanceof a.Field))throw Error("Illegal reflect child of "+this.toString(!0)+": "+m[q].toString(!0));
return this.clazz=d};a.prototype.encode=function(c,b){for(var d=this.getChildren(a.Field),e=0;e<d.length;e++)d[e].encode(c.get(d[e].name),b);return b};a.prototype.decode=function(a,d){d="number"===typeof d?d:-1;for(var e=a.offset,k=new this.clazz;a.offset<e+d||-1==d&&0<a.remaining();){var h=a.readVarint32(),f=h&7,h=h>>3,l=this.getChild(h);if(l)l.repeated&&!l.options.packed?k.add(l.name,l.decode(f,a)):k.set(l.name,l.decode(f,a));else switch(f){case c.WIRE_TYPES.VARINT:a.readVarint32();break;case c.WIRE_TYPES.BITS32:a.offset+=
4;break;case c.WIRE_TYPES.BITS64:a.offset+=8;break;case c.WIRE_TYPES.LDELIM:f=a.readVarint32();a.offset+=f;break;default:throw Error("Illegal wire type of unknown field "+h+" in "+this.toString(!0)+"#decode: "+f);}}e=this.getChildren(b.Field);for(f=0;f<e.length;f++)if(e[f].required&&null===k[e[f].name])throw e=Error("Missing field "+e[f].toString(!0)+" in "+this.toString(!0)+"#decode"),e.msg=k,e;return k};b.Message=a;var d=function(a,c,b,d,e,f){h.call(this,a,d);this.required="required"==c;this.repeated=
"repeated"==c;this.type=b;this.resolvedType=null;this.id=e;this.options=f||{}};d.prototype=Object.create(h.prototype);d.prototype.verifyValue=function(a,b){b=b||!1;if(null===a){if(this.required)throw Error("Illegal value for "+this.toString(!0)+": "+a+" (required)");return null}var d;if(this.repeated&&!b){c.Util.isArray(a)||(a=[a]);var f=[];for(d=0;d<a.length;d++)f.push(this.verifyValue(a[d],!0));return f}if(!this.repeated&&c.Util.isArray(a))throw Error("Illegal value for "+this.toString(!0)+": "+
a+" (no array expected)");if(this.type==c.TYPES.int32||this.type==c.TYPES.sint32||this.type==c.TYPES.sfixed32){d=parseInt(a,10);if(isNaN(d))throw Error("Illegal value for "+this.toString(!0)+": "+a+" (not a number)");return d|0}if(this.type==c.TYPES.uint32||this.type==c.TYPES.fixed32){d=parseInt(a,10);if(isNaN(d))throw Error("Illegal value for "+this.toString(!0)+": "+a+" (not a number)");return d>>>0}if(c.Long){if(this.type==c.TYPES.int64||this.type==c.TYPES.sint64||this.type==c.TYPES.sfixed64)return!("object"==
typeof a&&a instanceof c.Long)?c.Long.fromNumber(a,!1):a.unsigned?a.toSigned():a;if(this.type==c.TYPES.uint64||this.type==c.TYPES.fixed64)return!("object"==typeof a&&a instanceof c.Long)?c.Long.fromNumber(a,!0):a.unsigned?a:a.toUnsigned()}if(this.type==c.TYPES.bool)return!!a;if(this.type==c.TYPES["float"]||this.type==c.TYPES["double"]){d=parseFloat(a);if(isNaN(d))throw Error("Illegal value for "+this.toString(!0)+": "+a+" (not a number)");return d}if(this.type==c.TYPES.string)return""+a;if(this.type==
c.TYPES.bytes)return"object"==typeof a&&a instanceof p?a:p.wrap(a);if(this.type==c.TYPES["enum"]){f=this.resolvedType.getChildren(e.Value);for(d=0;d<f.length;d++)if(f[d].name==a||f[d].id==a)return f[d].id;throw Error("Illegal value for "+this.toString(!0)+": "+a+" (not a valid enum value)");}if(this.type==c.TYPES.message){if("object"!=typeof a)throw Error("Illegal value for "+this.toString(!0)+": "+a+" (object expected)");return a instanceof this.resolvedType.clazz?a:new this.resolvedType.clazz(a)}throw Error("[INTERNAL] Illegal value for "+
...
if(this.type==c.TYPES["enum"])return b.readVarint32();if(this.type==c.TYPES["float"])return b.readFloat();if(this.type==c.TYPES["double"])return b.readDouble();if(this.type==c.TYPES.string)return b.readVString();if(this.type==c.TYPES.bytes)return a=b.readVarint32(),d=b.clone(),d.length=d.offset+a,b.offset+=a,d;if(this.type==c.TYPES.message)return a=b.readVarint32(),this.resolvedType.decode(b,a);throw Error("[INTERNAL] Illegal wire type for "+this.toString(!0)+": "+a);};b.Message.Field=d;var e=function(a,
b,c){f.call(this,a,b,c);this.object=null};e.prototype=Object.create(f.prototype);e.prototype.build=function(){for(var a={},b=this.getChildren(e.Value),c=0;c<b.length;c++)a[b[c].name]=b[c].id;Object.defineProperty&&Object.defineProperty(a,"$options",{value:this.buildOpt(),enumerable:!1,configurable:!1,writable:!1});return this.object=a};b.Enum=e;d=function(a,b,c){h.call(this,a,b);this.id=c};d.prototype=Object.create(h.prototype);b.Enum.Value=d;var k=function(a,b,c){f.call(this,a,b,c);this.clazz=null};
k.prototype=Object.create(f.prototype);k.prototype.build=function(){return this.clazz=function(a){var d;try{d=eval("0, (function "+a.name+"() { ProtoBuf.Builder.Service.call(this); this.__construct.apply(this, arguments); })")}catch(e){d=function(){c.Builder.Service.call(this);this.__construct.apply(this,arguments)}}d.prototype=Object.create(c.Builder.Service.prototype);d.prototype.__construct=function(a){this.rpcImpl=a||function(a,b,c){setTimeout(c.bind(this,Error("Not implemented, see: https://github.com/dcodeIO/ProtoBuf.js/wiki/Services")),
0)}};Object.defineProperty&&(Object.defineProperty(d,"$options",{value:a.buildOpt(),enumerable:!1,configurable:!1,writable:!1}),Object.defineProperty(d.prototype,"$options",{value:d.$options,enumerable:!1,configurable:!1,writable:!1}));for(var f=a.getChildren(b.Service.RPCMethod),k=0;k<f.length;k++)(function(b){d.prototype[b.name]=function(c,d){try{(!c||!(c instanceof b.resolvedRequestType.clazz))&&setTimeout(d.bind(this,Error("Illegal request type provided to service method "+a.name+"#"+b.name))),
this.rpcImpl(b.name,c,function(c,e){if(c)d(c);else{try{e=b.resolvedResponseType.clazz.decode(e)}catch(f){}!e||!(e instanceof b.resolvedResponseType.clazz)?d(Error("Illegal response type received in service method "+a.name+"#"+b.name)):d(null,e)}})}catch(e){setTimeout(d.bind(this,e),0)}};d[b.name]=function(a,c,e){(new d(a))[b.name](c,e)};Object.defineProperty&&(Object.defineProperty(d[b.name],"$options",{value:b.buildOpt(),enumerable:!1,configurable:!1,writable:!1}),Object.defineProperty(d.prototype[b.name],
"$options",{value:d[b.name].$options,enumerable:!1,configurable:!1,writable:!1}))})(f[k]);return d}(this)};b.Service=k;var n=function(a,b,c){h.call(this,a,b);this.options=c||{}};n.prototype=Object.create(h.prototype);n.prototype.buildOpt=f.prototype.buildOpt;b.Service.Method=n;d=function(a,b,c,d,e){n.call(this,a,b,e);this.requestName=c;this.responseName=d;this.resolvedResponseType=this.resolvedRequestType=null};d.prototype=Object.create(n.prototype);b.Service.RPCMethod=d;return b}(h);h.Builder=function(c,
b,h){var f=function(){this.ptr=this.ns=new h.Namespace(null,"");this.resolved=!1;this.result=null;this.files={}};f.prototype.reset=function(){this.ptr=this.ns};f.prototype.define=function(a,c){if("string"!=typeof a||!b.TYPEDEF.test(a))throw Error("Illegal package name: "+a);var e=a.split("."),f;for(f=0;f<e.length;f++)if(!b.NAME.test(e[f]))throw Error("Illegal package name: "+e[f]);for(f=0;f<e.length;f++)this.ptr.hasChild(e[f])||this.ptr.addChild(new h.Namespace(this.ptr,e[f],c)),this.ptr=this.ptr.getChild(e[f]);
return this};f.isValidMessage=function(a){if("string"!=typeof a.name||!b.NAME.test(a.name)||"undefined"!=typeof a.values||"undefined"!=typeof a.rpc)return!1;var d;if("undefined"!=typeof a.fields){if(!c.Util.isArray(a.fields))return!1;var e=[],h;for(d=0;d<a.fields.length;d++){if(!f.isValidMessageField(a.fields[d]))return!1;h=parseInt(a.id,10);if(0<=e.indexOf(h))return!1;e.push(h)}}if("undefined"!=typeof a.enums){if(!c.Util.isArray(a.enums))return!1;for(d=0;d<a.enums.length;d++)if(!f.isValidEnum(a.enums[d]))return!1}if("undefined"!=
typeof a.messages){if(!c.Util.isArray(a.messages))return!1;for(d=0;d<a.messages.length;d++)if(!f.isValidMessage(a.messages[d]))return!1}return!0};f.isValidMessageField=function(a){if("string"!=typeof a.rule||"string"!=typeof a.name||"string"!=typeof a.type||"undefined"==typeof a.id||!b.RULE.test(a.rule)||!b.NAME.test(a.name)||!b.TYPEREF.test(a.type)||!b.ID.test(""+a.id))return!1;if("undefined"!=typeof a.options){if("object"!=typeof a.options)return!1;for(var c=Object.keys(a.options),e=0;e<c.length;e++)if(!b.NAME.test(c[e])||
"string"!=typeof a.options[c[e]]&&"number"!=typeof a.options[c[e]])return!1}return!0};f.isValidEnum=function(a){if("string"!=typeof a.name||!b.NAME.test(a.name)||"undefined"==typeof a.values||!c.Util.isArray(a.values)||0==a.values.length)return!1;for(var d=0;d<a.values.length;d++)if("object"!=typeof a.values[d]||"string"!=typeof a.values[d].name||"undefined"==typeof a.values[d].id||!b.NAME.test(a.values[d].name)||!b.NEGID.test(""+a.values[d].id))return!1;return!0};f.prototype.create=function(a){if(a&&
(c.Util.isArray(a)||(a=[a]),0!=a.length)){var d=[],e,k,n,g,m;for(d.push(a);0<d.length;){a=d.pop();if(c.Util.isArray(a))for(;0<a.length;)if(e=a.shift(),f.isValidMessage(e)){k=new h.Message(this.ptr,e.name,e.options);if(e.fields&&0<e.fields.length)for(g=0;g<e.fields.length;g++){if(!f.isValidMessageField(e.fields[g]))throw Error("Not a valid message field definition in message "+k.name+": "+JSON.stringify(e.fields[g]));if(k.hasChild(e.fields[g].id))throw Error("Duplicate field id in message "+k.name+
": "+e.fields[g].id);if(e.fields[g].options){n=Object.keys(e.fields[g].options);for(m=0;m<n.length;m++){if(!b.NAME.test(n[m]))throw Error("Illegal field option name in message "+k.name+"#"+e.fields[g].name+": "+n[m]);if("string"!=typeof e.fields[g].options[n[m]]&&"number"!=typeof e.fields[g].options[n[m]])throw Error("Illegal field option value in message "+k.name+"#"+e.fields[g].name+"#"+n[m]+": "+e.fields[g].options[n[m]]);}}k.addChild(new h.Message.Field(k,e.fields[g].rule,e.fields[g].type,e.fields[g].name,
e.fields[g].id,e.fields[g].options))}n=[];if("undefined"!=typeof e.enums&&0<e.enums.length)for(g=0;g<e.enums.length;g++)n.push(e.enums[g]);if(e.messages&&0<e.messages.length)for(g=0;g<e.messages.length;g++)n.push(e.messages[g]);this.ptr.addChild(k);0<n.length&&(d.push(a),a=n,this.ptr=k)}else if(f.isValidEnum(e)){k=new h.Enum(this.ptr,e.name,e.options);for(g=0;g<e.values.length;g++)k.addChild(new h.Enum.Value(k,e.values[g].name,e.values[g].id));this.ptr.addChild(k)}else if(f.isValidService(e)){k=new h.Service(this.ptr,
e.name,e.options);for(g in e.rpc)e.rpc.hasOwnProperty(g)&&k.addChild(new h.Service.RPCMethod(k,g,e.rpc[g].request,e.rpc[g].response,e.rpc[g].options));this.ptr.addChild(k)}else throw Error("Not a valid message, enum or service definition: "+JSON.stringify(e));else throw Error("Not a valid namespace definition: "+JSON.stringify(a));this.ptr=this.ptr.parent}this.resolved=!1;this.result=null;return this}};f.isValidImport=function(a){return!/google\/protobuf\//.test(a)};f.prototype["import"]=function(a,
b){if("string"===typeof b){c.Util.IS_NODE&&(b=require("path").resolve(b));if(this.files[b])return this.reset(),this;this.files[b]=!0}a.messages&&(a["package"]&&this.define(a["package"],a.options),this.create(a.messages),this.reset());a.enums&&(a["package"]&&this.define(a["package"],a.options),this.create(a.enums),this.reset());a.services&&(a["package"]&&this.define(a["package"],a.options),this.create(a.services),this.reset());if(a.imports&&0<a.imports.length){if(!b)throw Error("Cannot determine import root: File name is unknown");
for(var e=b.replace(/[\/\\][^\/\\]*$/,""),h=0;h<a.imports.length;h++){var l=e+"/"+a.imports[h];if(/\.json$/i.test(l)){var g=c.Util.fetch(l);if(null===g)throw Error("Failed to import '"+l+"' in '"+b+"': File not found");this["import"](JSON.parse(g),l)}else if(f.isValidImport(l)){g=c.Util.fetch(l);if(null===g)throw Error("Failed to import '"+l+"' in '"+b+"': File not found");g=new c.DotProto.Parser(g+"");this["import"](g.parse(),l)}}}return this};f.isValidService=function(a){return"string"!=typeof a.name||
!b.NAME.test(a.name)||"object"!=typeof a.rpc?!1:!0};f.prototype.resolveAll=function(){var a;if(!(null==this.ptr||"object"==typeof this.ptr.type)){if(this.ptr instanceof h.Namespace){a=this.ptr.getChildren();for(var d=0;d<a.length;d++)this.ptr=a[d],this.resolveAll()}else if(this.ptr instanceof h.Message.Field)if(b.TYPE.test(this.ptr.type))this.ptr.type=c.TYPES[this.ptr.type];else{if(!b.TYPEREF.test(this.ptr.type))throw Error("Illegal type reference in "+this.ptr.toString(!0)+": "+this.ptr.type);a=
this.ptr.parent.resolve(this.ptr.type);if(!a)throw Error("Unresolvable type reference in "+this.ptr.toString(!0)+": "+this.ptr.type);this.ptr.resolvedType=a;if(a instanceof h.Enum)this.ptr.type=c.TYPES["enum"];else if(a instanceof h.Message)this.ptr.type=c.TYPES.message;else throw Error("Illegal type reference in "+this.ptr.toString(!0)+": "+this.ptr.type);}else if(!(this.ptr instanceof c.Reflect.Enum.Value))if(this.ptr instanceof c.Reflect.Service.Method)if(this.ptr instanceof c.Reflect.Service.RPCMethod){a=
this.ptr.parent.resolve(this.ptr.requestName);if(!a||!(a instanceof c.Reflect.Message))throw Error("Illegal request type reference in "+this.ptr.toString(!0)+": "+this.ptr.requestName);this.ptr.resolvedRequestType=a;a=this.ptr.parent.resolve(this.ptr.responseName);if(!a||!(a instanceof c.Reflect.Message))throw Error("Illegal response type reference in "+this.ptr.toString(!0)+": "+this.ptr.responseName);this.ptr.resolvedResponseType=a}else throw Error("Illegal service method type in "+this.ptr.toString(!0));
else throw Error("Illegal object type in namespace: "+typeof this.ptr+":"+this.ptr);this.reset()}};f.prototype.build=function(a){this.reset();this.resolved||(this.resolveAll(),this.resolved=!0,this.result=null);null==this.result&&(this.result=this.ns.build());if(a){a=a.split(".");for(var b=this.result,c=0;c<a.length;c++)if(b[a[c]])b=b[a[c]];else{b=null;break}return b}return this.result};f.prototype.lookup=function(a){return a?this.ns.resolve(a):this.ns};f.prototype.toString=function(){return"Builder"};
f.Message=function(){};f.Service=function(){};return f}(h,h.Lang,h.Reflect);h.protoFromString=function(c,b,l){"string"==typeof b&&(l=b,b=null);c=(new h.DotProto.Parser(c+"")).parse();b="object"==typeof b?b:new h.Builder;0<c.messages.length&&(null!==c["package"]&&b.define(c["package"],c.options),b.create(c.messages),b.reset());0<c.enums.length&&(null!==c["package"]&&b.define(c["package"],c.options),b.create(c.enums),b.reset());0<c.services.length&&(null!==c["package"]&&b.define(c["package"],c.options),
b.create(c.services),b.reset());if(l&&0<c.imports.length)b["import"]({imports:c.imports},l);b.resolveAll();b.build();return b};h.protoFromFile=function(c,b,l){if(b&&"object"==typeof b)l=b,b=null;else if(!b||"function"!=typeof b)b=null;if(b)h.Util.fetch(c,function(a){b(h.protoFromString(a,l,c))});else{var f=h.Util.fetch(c);return null!==f?h.protoFromString(f,l,c):null}};h.newBuilder=function(c,b){var l=new h.Builder;"undefined"!=typeof c&&l.define(c,b);return l};return h}"undefined"!=typeof module&&
module.exports?module.exports=s(require("bytebuffer")):"undefined"!=typeof define&&define.amd?define("ProtoBuf",["ByteBuffer"],s):(r.dcodeIO||(r.dcodeIO={}),r.dcodeIO.ProtoBuf=s(r.dcodeIO.ByteBuffer))})(this);